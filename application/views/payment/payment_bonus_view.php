...
<?php echo form_open(); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <label style="padding-top: 10px;">Select Type</label>
        </div>
        <div class="col-md-4">
            <select class="basic-single form-select shadow-none form-control-line" id="bonus_type" name="bonus_type" required>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <input type="number" id="bonus_amount" name="bonus_amount" autocomplete="off" class="form-control margin-bottom-05 text-center" step="0.01" required>
        </div>
    </div>
    <br>
    <div class="row">
        ...
        <div class="col-md-4">
            <input type="text" id="bonus_remarks" name="bonus_remarks" class="form-control margin-bottom-05" placeholder="Bonus Remarks" maxlength="50" required>
        </div>
    </div>
    <br>
    <div class="row">
        ...
        <div class="col-md-4 text-center">
            <button class="btn btn-success text-white mb-2" id="submit" name="submit" value="submit">Add Entry&nbsp;&nbsp;<span><i class="fa fa-check"></i></span></button>
        </div>
    </div>
</form>
